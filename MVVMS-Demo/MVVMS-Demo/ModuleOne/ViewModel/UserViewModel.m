...
- (void)getUserDatas {
    self.viewState = UserViewStateShowIndicator;
    __weak typeof(self) wkself = self;
    [self.userService getUserInfosSuccess:^(NSDictionary *dic) {
        wkself.viewState = UserViewStateHideshowIndicator;
        ...
        wkself.viewState = UserViewStateReloadTableView;
        
        if (dataArrays.count == 0) {
            wkself.viewState = UserViewStateShowEmpty;
        }
